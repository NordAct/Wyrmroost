...
{
    private final WRModelPart[] headArray;
    private final WRModelPart[] tailArray;
    private final WRModelPart[] toeArray;
    public WRModelPart neck1;
    public WRModelPart backFin;
    public WRModelPart bottomFin;
    public WRModelPart mainBody;
    public WRModelPart secondaryBody;
    ...
    public WRModelPart tailFin;
    public WRModelPart toeL2;
    public WRModelPart legR2;
    public WRModelPart legR3;
    public WRModelPart toeL3;
    public WRModelPart toeL1;
    public WRModelPart toeR2;
    ...
    public WRModelPart toeR3;
    public WRModelPart toeR1;
    public WRModelPart wing2R;
    public WRModelPart wingMembraneR1;
    public WRModelPart wingMembraneElbowR;
    public WRModelPart phalangeR1;
    public WRModelPart wingMembraneR2;
    public WRModelPart phalangeR2;
    public WRModelPart wingMembraneR3;
    public WRModelPart phalangeSegmentR1;
    public WRModelPart phalangeR3;
    public WRModelPart wingMembraneR4;
    public WRModelPart wingMembraneR5;
    public WRModelPart phalangeSegmentR2;
    public WRModelPart wing2L;
    public WRModelPart wingMembraneL1;
    public WRModelPart wingMembraneElbowL;
    public WRModelPart phalangeL1;
    public WRModelPart wingMembraneL2;
    public WRModelPart phalangeL2;
    public WRModelPart wingMembraneL3;
    public WRModelPart phalangeSegmentL1;
    public WRModelPart phalangeL3;
    public WRModelPart wingMembraneL4;
    public WRModelPart wingMembraneL4_1;
    public WRModelPart phalangeSegmentL2;

    public SilverGliderModel()
    {
        super(160, 125);
        toeL1 = new WRModelPart(this, 60, 20);
        ...
        mouthTop = new WRModelPart(this, 67, 10);
        ...
        eyeL = new WRModelPart(this, 79, 2);
        ...
        toeR2 = new WRModelPart(this, 60, 20);
        ...
        toeL3 = new WRModelPart(this, 60, 20);
        ...
        phalangeSegmentL1 = new WRModelPart(this, 0, 70);
        ...
        phalangeSegmentL2 = new WRModelPart(this, 33, 69);
        ...
        phalangeR2 = new WRModelPart(this, 33, 65);
        ...
        legR3 = new WRModelPart(this, 58, 14);
        ...
        legR1 = new WRModelPart(this, 56, 0);
        ...
        phalangeSegmentR1 = new WRModelPart(this, 0, 70);
        ...
        legL2 = new WRModelPart(this, 56, 8);
        ...
        tail2 = new WRModelPart(this, 88, 53);
        ...
        headArray = new WRModelPart[] {neck1, neck2, neck3, neck4, head};
        tailArray = new WRModelPart[] {tail1, tail2, tail3, tail4, tail5, tail6, tail7, tail8, tail9, tail10};
        toeArray = new WRModelPart[] {toeR1, toeR2, toeR3, toeL1, toeL2, toeL3};
    ...
    {
        mainBody.render(ms, buffer, packedLightIn, packedOverlayIn, color);
    }
    ...
    public void sit(float amount)
    {
        ...
        for (WRModelPart segment : tailArray) rotate(segment, -0.035f, -0.35f, 0);
    ...
    public void sleep(float amount)
    {
        ...
        for (WRModelPart part : headArray) rotate(part, 0.05f, 0.5f, 0);
    ...
    public void flight(float amount)
    {
        ...
        if (!entity.isGliding())
        {
            ...
            for (WRModelPart toe : toeArray) rotate(toe, 1f, 0, 0);
        }
    }
}
