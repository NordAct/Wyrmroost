...
public class DragonFruitDrakeModel extends WREntityModel<DragonFruitDrakeEntity>
{
    ...
    public WRModelPart LegfrontR1;
    public WRModelPart BackLeafMiddle;
    public WRModelPart BackLeafL;
    public WRModelPart BackLeafR;
    public WRModelPart SideLeaf1R;
    public WRModelPart SideLeaf2R;
    public WRModelPart SideLeaf1L;
    public WRModelPart SideLeaf2L;
    public WRModelPart LegfrontL1;
    public WRModelPart Tail1;
    public WRModelPart LegThighR;
    public WRModelPart BackLeaf2Middle;
    public WRModelPart BackLeafL_1;
    public WRModelPart BackLeafR_1;
    public WRModelPart LegThighR_1;
    public WRModelPart Tail2;
    public WRModelPart TailLeaf1;
    public WRModelPart Tail3;
    public WRModelPart TailLeaf2;
    public WRModelPart Tail4;
    public WRModelPart TailLeaf3;
    public WRModelPart Tail5;
    public WRModelPart TailLeaf4;
    public WRModelPart Tail6;
    public WRModelPart BackLeaf1;
    public WRModelPart Tail7;
    public WRModelPart TailLeafEND;
    public WRModelPart LegSegmentR1;
    public WRModelPart LegSegmentR2;
    public WRModelPart LegSegmentR3;
    public WRModelPart backfootR;
    public WRModelPart LegSegmentL1;
    public WRModelPart LegSegmentL2;
    public WRModelPart LegSegmentL3;
    public WRModelPart backfootL;
    public WRModelPart neck3;
    public WRModelPart Neck1Leaf;
    public WRModelPart neck4;
    public WRModelPart Neck2Leaf;
    public WRModelPart Head;
    public WRModelPart NeckLeaf3;
    public WRModelPart mouthtop;
    public WRModelPart mouthbottom;
    public WRModelPart EyeR;
    public WRModelPart shape71;
    public WRModelPart shape71_1;
    public WRModelPart EyeL;
    public WRModelPart LegfrontR2;
    public WRModelPart LegfrontR3;
    public WRModelPart frontfootR;
    public WRModelPart LegfrontL2;
    public WRModelPart LegfrontL3;
    public WRModelPart frontfootL;
    ...
    {
        super(100, 70);
        BackLeaf2Middle = new WRModelPart(this, 0, 23);
        ...
        BackLeafL_1 = new WRModelPart(this, 0, 23);
        ...
        shape71 = new WRModelPart(this, 6, 26);
        shape71.mirror = true;
        ...
        LegfrontL1 = new WRModelPart(this, 34, 18);
        ...
        Tail5 = new WRModelPart(this, 86, 34);
        ...
        BackLeafMiddle = new WRModelPart(this, 0, 23);
        ...
        EyeL = new WRModelPart(this, 16, 0);
        EyeL.mirror = true;
        ...
        neck2 = new WRModelPart(this, 23, 0);
        ...
        LegfrontL3 = new WRModelPart(this, 40, 39);
        ...
        Neck2Leaf = new WRModelPart(this, 5, 15);
        ...
        frontfootR = new WRModelPart(this, 40, 46);
        ...
        LegfrontR3 = new WRModelPart(this, 40, 39);
        ...
        LegSegmentL2 = new WRModelPart(this, 55, 41);
        ...
        NeckLeaf3 = new WRModelPart(this, 0, 14);
        ...
        LegSegmentL3 = new WRModelPart(this, 61, 50);
        ...
        BackLeafR = new WRModelPart(this, 0, 23);
        ...
        Tail2 = new WRModelPart(this, 80, 13);
        ...
        neck3 = new WRModelPart(this, 23, 0);
        ...
        EyeR = new WRModelPart(this, 16, 0);
        ...
        Neck1Leaf = new WRModelPart(this, 10, 16);
        ...
        BackLeafR_1 = new WRModelPart(this, 0, 23);
        ...
        Tail3 = new WRModelPart(this, 82, 24);
        ...
        SideLeaf1R = new WRModelPart(this, 0, 29);
        ...
        SideLeaf1L = new WRModelPart(this, 0, 29);
        ...
        Tail4 = new WRModelPart(this, 82, 24);
        ...
        TailLeaf3 = new WRModelPart(this, 0, 23);
        ...
        Tail1 = new WRModelPart(this, 80, 13);
        ...
        frontfootL = new WRModelPart(this, 40, 46);
        ...
        LegfrontL2 = new WRModelPart(this, 34, 29);
        ...
        Tail7 = new WRModelPart(this, 88, 42);
        ...
        Tail6 = new WRModelPart(this, 86, 34);
        ...
        shape71_1 = new WRModelPart(this, 6, 26);
        ...
        TailLeaf2 = new WRModelPart(this, 0, 23);
        ...
        LegfrontR1 = new WRModelPart(this, 34, 18);
        ...
        BackLeaf1 = new WRModelPart(this, 0, 29);
        ...
        LegfrontR2 = new WRModelPart(this, 34, 29);
        ...
        LegSegmentR1 = new WRModelPart(this, 57, 31);
        ...
        backfootR = new WRModelPart(this, 61, 55);
        ...
        neck4 = new WRModelPart(this, 23, 0);
        ...
        LegSegmentL1 = new WRModelPart(this, 57, 31);
        ...
        SideLeaf2L = new WRModelPart(this, 0, 29);
        ...
        TailLeaf4 = new WRModelPart(this, 0, 29);
        ...
        headArray = new WRModelPart[] {neck2, neck3, neck4, Head};
        tailArray = new WRModelPart[] {Tail1, Tail2, Tail3, Tail4, Tail5, Tail6, Tail7, TailLeafEND};
    ...
    public void renderToBuffer(PoseStack ms, VertexConsumer buffer, int light, int overlay, int color)
    {
        ...
        Body1.render(ms, buffer, light, overlay, color);
        ms.popPose();
    }
