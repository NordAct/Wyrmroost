...
public class OWDrakeModel extends WREntityModel<OWDrakeEntity>
{
    ...
    public WRModelPart horn11L;
    public WRModelPart horn11R;
    public WRModelPart horn31L;
    public WRModelPart horn31R;
    public WRModelPart horn51;
    public WRModelPart horn52;
    public WRModelPart horn53;
    public WRModelPart horn12L;
    public WRModelPart horn12R;
    public WRModelPart horn32L;
    public WRModelPart horn33L;
    public WRModelPart horn32R;
    public WRModelPart horn33R;
    public WRModelPart arm2L;
    public WRModelPart palmL;
    public WRModelPart claw21L;
    public WRModelPart claw11L;
    public WRModelPart claw22L;
    public WRModelPart claw12L;
    public WRModelPart arm2R;
    public WRModelPart palmR;
    public WRModelPart claw21R;
    public WRModelPart claw11R;
    public WRModelPart claw22R;
    public WRModelPart claw12R;
    ...
    {
        super(200, 200);
        claw12L = new WRModelPart(this, 129, 79);
        ...
        arm2L = new WRModelPart(this, 111, 76);
        ...
        leg3R = new WRModelPart(this, 60, 94);
        ...
        eyeR = new WRModelPart(this, 67, 40);
        eyeR.mirror = true;
        ...
        claw22R = new WRModelPart(this, 129, 79);
        ...
        arm1R = new WRModelPart(this, 111, 61);
        arm1R.mirror = true;
        ...
        tail2 = new WRModelPart(this, 0, 55);
        ...
        tail4 = new WRModelPart(this, 0, 85);
        ...
        toe1R_1 = new WRModelPart(this, 77, 85);
        ...
        horn12R = new WRModelPart(this, 95, 32);
        ...
        toe2L = new WRModelPart(this, 77, 85);
        ...
        toe1L_1 = new WRModelPart(this, 77, 85);
        ...
        footR = new WRModelPart(this, 60, 85);
        ...
        claw12R = new WRModelPart(this, 129, 79);
        ...
        horn32R = new WRModelPart(this, 95, 24);
        ...
        horn52 = new WRModelPart(this, 97, 10);
        ...
        palmR = new WRModelPart(this, 129, 61);
        ...
        leg2L = new WRModelPart(this, 42, 94);
        leg2L.mirror = true;
        ...
        claw21R = new WRModelPart(this, 129, 71);
        ...
        horn11R = new WRModelPart(this, 79, 32);
        ...
        horn12L = new WRModelPart(this, 95, 32);
        ...
        neck1 = new WRModelPart(this, 40, 0);
        ...
        horn31L = new WRModelPart(this, 79, 22);
        ...
        horn51 = new WRModelPart(this, 80, 7);
        ...
        horn32L = new WRModelPart(this, 95, 24);
        ...
        claw22L = new WRModelPart(this, 129, 79);
        ...
        eyeL = new WRModelPart(this, 67, 40);
        ...
        body2 = new WRModelPart(this, 0, 20);
        ...
        horn31R = new WRModelPart(this, 79, 22);
        ...
        horn11L = new WRModelPart(this, 79, 32);
        ...
        tail5 = new WRModelPart(this, 0, 102);
        ...
        tail3 = new WRModelPart(this, 0, 70);
        ...
        toe1L = new WRModelPart(this, 77, 85);
        ...
        claw21L = new WRModelPart(this, 129, 71);
        ...
        horn33R = new WRModelPart(this, 105, 24);
        horn33R.mirror = true;
        ...
        footL = new WRModelPart(this, 60, 85);
        ...
        leg3L = new WRModelPart(this, 60, 94);
        ...
        toe1R = new WRModelPart(this, 77, 85);
        ...
        palmL = new WRModelPart(this, 129, 61);
        ...
        horn33L = new WRModelPart(this, 105, 24);
        ...
        claw11R = new WRModelPart(this, 129, 71);
        ...
        neck2 = new WRModelPart(this, 40, 15);
        ...
        snout = new WRModelPart(this, 40, 44);
        ...
        arm1L = new WRModelPart(this, 111, 61);
        ...
        leg2R = new WRModelPart(this, 42, 94);
        ...
        tail1 = new WRModelPart(this, 0, 39);
        ...
        horn53 = new WRModelPart(this, 107, 10);
        ...
        claw11L = new WRModelPart(this, 129, 71);
        ...
        headArray = new WRModelPart[] {neck1, neck2, head};
        tailArray = new WRModelPart[] {tail1, tail2, tail3, tail4, tail5};
        toeArray = new WRModelPart[] {toe1L, toe1L_1, toe1R, toe1R_1, toe2L, toe2R};
    ...
    public void sit(float amount)
    {
        ...
        for (WRModelPart toeSegment : toeArray) rotate(toeSegment, 0.8f, 0, 0);
        for (WRModelPart tailSegment : tailArray) rotate(tailSegment, 0, -0.8f, 0);
    ...
    private void hornAttackAnim()
    {
        ...
        for (WRModelPart segment : tailArray) animator.rotate(segment, -0.05f, 0, 0);
...
//        animator.setStaticKeyframe(1);
        ...
        for (WRModelPart segment : tailArray) animator.rotate(segment, 0.025f, 0, 0);
        animator.endKeyframe();
    ...
    private void roarAnim(OWDrakeEntity entity, float frame)
    {
        ...
        for (WRModelPart tailSegment : tailArray) animator.rotate(tailSegment, 0.1f, 0, 0);
        animator.endKeyframe();
