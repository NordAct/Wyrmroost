...
public class RoyalRedModel extends WREntityModel<RoyalRedEntity>
{
    ...
    public WRModelPart tailspike1part1;
    public WRModelPart tailspike1part2;
    public WRModelPart tailspike3part1;
    public WRModelPart tailspike4part1;
    public WRModelPart spike12;
    public WRModelPart tailspike2part1;
    public WRModelPart tailspike2part2;
    public WRModelPart tailspike2part3;
    public WRModelPart tailspike2part4;
    ...
    public WRModelPart[] tailParts;
    public WRModelPart[] headParts;
    ...
    public RoyalRedModel()
    {
        ...
        this.membraneL6 = new WRModelPart(this, -20, 61);
        ...
        this.tailspike2part4 = new WRModelPart(this, 25, 16);
        ...
        this.tailspike3part1 = new WRModelPart(this, 0, 15);
        ...
        this.spike31 = new WRModelPart(this, 28, 43);
        ...
        this.membraneR1 = new WRModelPart(this, 70, 93);
        ...
        this.tailspike2part3 = new WRModelPart(this, 14, 16);
        ...
        this.membraneL2 = new WRModelPart(this, 71, 82);
        ...
        this.tailspike1part2 = new WRModelPart(this, 0, 20);
        ...
        this.tailspike2part2 = new WRModelPart(this, 25, 16);
        ...
        this.tailspike2part1 = new WRModelPart(this, 14, 16);
        ...
        this.membraneL3 = new WRModelPart(this, 61, 61);
        ...
        this.membraneR6 = new WRModelPart(this, -20, 61);
        ...
        this.tailspike4part1 = new WRModelPart(this, 0, 20);
        ...
        this.membraneL4 = new WRModelPart(this, -15, 103);
        ...
        this.membraneR2 = new WRModelPart(this, 71, 82);
        ...
        this.membraneL5 = new WRModelPart(this, -20, 82);
        ...
        this.membraneR3 = new WRModelPart(this, 61, 61);
        ...
        this.membraneR4 = new WRModelPart(this, -15, 103);
        ...
        this.membraneL1 = new WRModelPart(this, 70, 93);
        ...
        this.membraneR5 = new WRModelPart(this, -20, 82);
        ...
        this.tailspike1part1 = new WRModelPart(this, 0, 15);
        ...
        this.tailParts = new WRModelPart[] {tail1, tail2, tail3, tail4, tail5, tail6, tail7, tail8};
        this.headParts = new WRModelPart[] {neck1, neck2, neck3, head};
    ...
    public void renderToBuffer(PoseStack ms, VertexConsumer buffer, int packedLightIn, int packedOverlayIn, int color)
    {
        ...
        body2.render(ms, buffer, packedLightIn, packedOverlayIn, color);
        ms.popPose();
    }

    @Override
    public void setupAnim(RoyalRedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void prepareMobModel(RoyalRedEntity entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        this.entity = entity;
    ...
    public void idle(float frame)
    {
        if (entity.flightTimer.get() == 0)
        {
            if (entity.isKnockedOut())
            {
                ...
                jaw.xRot += Mth.cos(frame * (globalSpeed - 0.48f)) * 0.1f + 0.1f;
            ...
            else
            {
                ...
                jaw.xRot += Mth.cos(frame * (globalSpeed - 0.45f)) * 0.1f + 0.1f;
                ...
                {
                    body1.xRot += Mth.cos(frame * (globalSpeed - 0.45f)) * 0.075f;
    ...
    private void roarAnimation(float frame, float partialTick)
    {
        ...
        for (WRModelPart tailPart : tailParts) animator.rotate(tailPart, 0.08f, 0, 0);
    ...
    private void keepSlapStance()
    {
        ...
        for (WRModelPart tailPart : tailParts) animator.rotate(tailPart, 0.1f, 0, 0);
        for (WRModelPart headPart : headParts) animator.rotate(headPart, 0.4f, 0, 0);
    }
}
