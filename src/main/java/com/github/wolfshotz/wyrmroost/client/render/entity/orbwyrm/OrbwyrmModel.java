...
//{
//    private final WRModelPart[] tails;
//    private final WRModelPart[] necks;
//    private final WRModelPart[] eyes;
...
//    public WRModelPart quills4;
//    public WRModelPart tail1;
//    public WRModelPart quills5;
//    public WRModelPart tail2;
//    public WRModelPart quills6;
//    public WRModelPart tail3;
//    public WRModelPart quills7;
//    public WRModelPart tail4;
//    public WRModelPart tail5;
//    public WRModelPart tail6;
//    public WRModelPart tail7;
//    public WRModelPart tail8;
//    public WRModelPart spike0L;
//    public WRModelPart spike0R;
//    public WRModelPart tail9;
//    public WRModelPart spike1L;
//    public WRModelPart spike1R;
//    public WRModelPart tail10;
//    public WRModelPart quills8;
//    public WRModelPart spike2L;
//    public WRModelPart spike2R;
//    public WRModelPart tail11;
//    public WRModelPart quills9;
//    public WRModelPart spike3L;
//    public WRModelPart spike3R;
//    public WRModelPart tail12;
//    public WRModelPart spike4L;
//    public WRModelPart spike4R;
//    public WRModelPart tail13;
//    public WRModelPart spike5L;
//    public WRModelPart spike5R;
//    public WRModelPart tail14;
//    public WRModelPart spike6L;
//    public WRModelPart spike6R;
//    public WRModelPart spike7L;
//    public WRModelPart spike7R;
//    public WRModelPart neck2;
//    public WRModelPart neck3;
//    public WRModelPart quills3;
//    public WRModelPart neck4;
//    public WRModelPart quills2;
//    public WRModelPart quills1;
//    public WRModelPart neck5;
//    public WRModelPart quills1_1;
//    public WRModelPart neck6;
//    public WRModelPart head;
//    public WRModelPart nose;
//    public WRModelPart jawR;
//    public WRModelPart horn1L;
//    public WRModelPart horn1R;
//    public WRModelPart eye1L;
//    public WRModelPart eye2L;
//    public WRModelPart eye3L;
//    public WRModelPart eye1R;
//    public WRModelPart eye2R;
//    public WRModelPart eye3R;
//    public WRModelPart jawL;
//    public WRModelPart teeth;
//    public WRModelPart chinR;
//    public WRModelPart cheekR;
//    public WRModelPart teethR;
//    public WRModelPart horn2L;
//    public WRModelPart horn2R;
//    public WRModelPart chinL;
//    public WRModelPart cheekL;
//    public WRModelPart teethL;
//    public WRModelPart wing2L;
//    public WRModelPart palmL;
//    public WRModelPart clawL2;
//    public WRModelPart clawL1;
//    public WRModelPart clawL3;
//    public WRModelPart wing2R;
//    public WRModelPart palmR;
//    public WRModelPart clawR2;
//    public WRModelPart clawR3;
//    public WRModelPart clawR1;
//    public WRModelPart arm2L;
//    public WRModelPart spikeL;
//    public WRModelPart arm2R;
//    public WRModelPart spikeR;
//
//    public OrbwyrmModel()
//    {
//        textureWidth = 150;
//        textureHeight = 100;
//        spike4R = new WRModelPart(this, 102, 19);
...
//        horn2R = new WRModelPart(this, 16, 78);
//        horn2R.mirror = true;
...
//        quills4 = new WRModelPart(this, 95, 20);
...
//        horn1R = new WRModelPart(this, 16, 71);
//        horn1R.mirror = true;
...
//        body2 = new WRModelPart(this, 45, 0);
...
//        quills3 = new WRModelPart(this, 100, 20);
...
//        chinR = new WRModelPart(this, 13, 58);
//        chinR.mirror = true;
...
//        horn1L = new WRModelPart(this, 16, 71);
...
//        spike7R = new WRModelPart(this, 102, 19);
...
//        cheekR = new WRModelPart(this, 0, 73);
...
//        eye3L = new WRModelPart(this, 14, 65);
...
//        eye2L = new WRModelPart(this, 14, 65);
...
//        jawR = new WRModelPart(this, 0, 64);
...
//        spike1R = new WRModelPart(this, 102, 19);
...
//        wing2R = new WRModelPart(this, 40, 22);
...
//        neck6 = new WRModelPart(this, 30, 57);
...
//        tail4 = new WRModelPart(this, 117, 0);
//        tail4.mirror = true;
...
//        wing1L = new WRModelPart(this, 27, 22);
...
//        tail6 = new WRModelPart(this, 121, 16);
//        tail6.mirror = true;
...
//        horn2L = new WRModelPart(this, 16, 78);
...
//        jawL = new WRModelPart(this, 0, 64);
//        jawL.mirror = true;
...
//        spike1L = new WRModelPart(this, 102, 19);
//        spike1L.mirror = true;
...
//        palmL = new WRModelPart(this, 25, 38);
...
//        clawL2 = new WRModelPart(this, 57, 23);
...
//        quills2 = new WRModelPart(this, 100, 20);
...
//        wing1R = new WRModelPart(this, 27, 22);
//        wing1R.mirror = true;
...
//        spike7L = new WRModelPart(this, 102, 19);
//        spike7L.mirror = true;
...
//        arm2R = new WRModelPart(this, 79, 23);
...
//        spike2R = new WRModelPart(this, 102, 19);
...
//        quills9 = new WRModelPart(this, 57, 25);
...
//        palmR = new WRModelPart(this, 25, 38);
...
//        eye2R = new WRModelPart(this, 14, 65);
//        eye2R.mirror = true;
...
//        quills6 = new WRModelPart(this, 57, 25);
...
//        spike2L = new WRModelPart(this, 102, 19);
//        spike2L.mirror = true;
...
//        clawR3 = new WRModelPart(this, 57, 23);
...
//        arm1L = new WRModelPart(this, 70, 23);
...
//        eye1L = new WRModelPart(this, 14, 65);
...
//        spike3L = new WRModelPart(this, 102, 19);
//        spike3L.mirror = true;
...
//        arm1R = new WRModelPart(this, 70, 23);
...
//        wing2L = new WRModelPart(this, 40, 22);
//        wing2L.mirror = true;
...
//        clawL3 = new WRModelPart(this, 57, 23);
...
//        quills8 = new WRModelPart(this, 57, 25);
...
//        spike0L = new WRModelPart(this, 102, 19);
//        spike0L.mirror = true;
...
//        arm2L = new WRModelPart(this, 79, 23);
...
//        spike6R = new WRModelPart(this, 102, 19);
...
//        spike5L = new WRModelPart(this, 102, 19);
//        spike5L.mirror = true;
...
//        nose = new WRModelPart(this, 0, 58);
...
//        eye1R = new WRModelPart(this, 14, 65);
//        eye1R.mirror = true;
...
//        chinL = new WRModelPart(this, 13, 58);
...
//        tail3 = new WRModelPart(this, 117, 0);
...
//        quills5 = new WRModelPart(this, 74, 23);
...
//        head = new WRModelPart(this, 0, 47);
...
//        quills7 = new WRModelPart(this, 57, 25);
...
//        spikeL = new WRModelPart(this, 88, 23);
...
//        cheekL = new WRModelPart(this, 0, 73);
//        cheekL.mirror = true;
...
//        spike5R = new WRModelPart(this, 102, 19);
...
//        spike4L = new WRModelPart(this, 102, 19);
//        spike4L.mirror = true;
...
//        eye3R = new WRModelPart(this, 14, 65);
//        eye3R.mirror = true;
...
//        neck5 = new WRModelPart(this, 0, 35);
...
//        neck1 = new WRModelPart(this, 0, 22);
...
//        tail5 = new WRModelPart(this, 121, 16);
...
//        tail1 = new WRModelPart(this, 84, 0);
...
//        clawR1 = new WRModelPart(this, 57, 23);
...
//        neck4 = new WRModelPart(this, 0, 35);
//        neck4.mirror = true;
...
//        tail7 = new WRModelPart(this, 123, 31);
...
//
//        this.tails = new WRModelPart[] {tail1, tail2, tail3, tail4, tail5, tail6, tail7, tail8, tail9, tail10, tail11, tail12, tail13, tail14};
//        this.necks = new WRModelPart[] {neck1, neck2, neck3, neck4, neck5, neck6, head};
//        this.eyes = new WRModelPart[] {eye1R, eye2R, eye3R, eye1L, eye2L, eye3L};
//
...
//        for (WRModelPart part : necks) rotate(part, 0.275f, 0, 0);
...
//        for (WRModelPart part : necks) animator.rotate(part, -part.rotateAngleX + 0.075f, 0, 0);
...
//        for (WRModelPart part : necks) animator.rotate(part, 0, 0.2f, 0);
//        float tick = animator.getEntity().getAnimationTick();
//        if (tick < 14)
//        {
//            float prev = tick--;
